const n = [
	...
	{
		question: "1931年,中国東方部で日本軍が起こした軍事行動。",
		hint: "柳条湖で線路が爆破され、その後の展開が東アジアの歴史を大きく変えました。",
		answers: ["満州事変"],
		explanation: "1931年9月18日、関東軍が柳条湖で満鉄線路を爆破し、満州侵略を開始した事件。"
	},
	{
		question: "第二次世界大戦中,ベルリン郊外にある都市で,アメリカ・中国・イギリスの名で発表された日本の克服条件を記した宣言。",
		hint: "この宣言は、第二次世界大戦末期に発表されました。ドイツの首都の近くにある都市で行われた会談で採択されましたが、実際にはドイツではなく、別の国を対象としていました。この宣言には、アメリカ、イギリス、中国が署名しており、日本に対する重要な要求が含まれていました。",
		answers: ["ポツダム宣言"],
		explanation: "ポツダム宣言は1945年7月26日にベルリン郊外のポツダムで発表された4。日本に無条件降伏を要求した重要な文書である。"
	},
	{
		question: "第二次世界大戦中,ベルリン郊外にある都市で,アメリカ・中国・イギリスの名で発表された日本の克服条件を記した宣言。",
		hint: "この宣言は、第二次世界大戦末期に発表されました。ドイツの首都の近くにある都市で行われた会談で採択されましたが、実際にはドイツではなく、別の国を対象としていました。この宣言には、アメリカ、イギリス、中国が署名しており、日本に対する重要な要求が含まれていました。",
	...
	{
		question: "第二次世界大戦後,政府が,連合国軍総司令部の指令を受けて,これまで独占的に経済を支配してきた大資本家に対して,株を分散させたり会社を分けさせたりした政策",
		hint: "第二次世界大戦後、日本の経済復興のために連合国軍総司令部（GHQ）は、特定の経済勢力の影響力を削ぐ政策を実施しました。この政策は、三井や三菱などの巨大な企業グループに影響を与えました。また、この政策は農地改革や労働三法と並ぶ「三大改革」の一つとされています。。",
		answers: ["財閥解体"],
		explanation: "財閥解体は、戦争遂行の基盤となった大財閥を分割し、経済の民主化を図る政策です。"
	},
